...
**15.2** O exercício de trabalho em condições de insalubridade, de acordo com os subitens do item anterior, assegura ao trabalhador a percepção de adicional, incidente sobre o salário mínimo da
...
**ANEXO Nº 1**
**LIMITES DE TOLERÂNCIA PARA RUÍDO CONTÍNUO OU INTERMITENTE** **1.** Entende-se por Ruído Contínuo ou Intermitente, para os fins de aplicação de Limites de Tolerância,
...
![Tabela da página 3](../assets/pages/page-003-table-00.png)
...
![Tabela da página 6](../assets/pages/page-006-table-00.png)

**Quadro 2** - Taxa metabólica por tipo de atividade

![Tabela da página 7](../assets/pages/page-007-table-00.png)

![Tabela da página 7](../assets/pages/page-007-table-01.png)

![Tabela da página 8](../assets/pages/page-008-table-00.png)
...
![Tabela da página 9](../assets/pages/page-009-table-00.png)
...
![Tabela da página 12](../assets/pages/page-012-table-00.png)
...
| Col1 | FRENTE |
| --- | --- |
| | 4 cm EM CASO DE INCOSNCIÊNCIA OU MAL DE CAUSA INDETERMINADA TELEFONAR PARA O Nº_____________ E ENCAMINHAR O PORTADOR DESTA PARA ___________ |
| | 6 cm |
...
| | 6 cm | ESPECIFICAÇÃO DO MATERIAL DA PLACA: Alumínio com espessura de 2 mm |
...
![Tabela da página 15](../assets/pages/page-015-table-02.png)
...
![Tabela da página 17](../assets/pages/page-017-table-02.png)
...
![Tabela da página 20](../assets/pages/page-020-table-02.png)
...
![Tabela da página 21](../assets/pages/page-021-table-01.png)

![Tabela da página 21](../assets/pages/page-021-table-02.png)
...
XXIII - **Pressão Ambiente** : a pressão do meio que envolve o mergulhador; XXIV - **Programa Médico** : o conjunto de atividades desenvolvidas pelo empregador, na área
...
desenvolvidos de acordo com o estabelecido neste item; b) exigir do empregador que apresente Certificado de Cadastramento expedido pela Diretoria
...
operar, se oferecerem perigo para os mergulhadores em operação; d) providenciar para que o supervisor de mergulho seja informado, antes do início da operação
...
sino de mergulho ou câmara submersível de pressão atmosférica, é obrigatória a disponibilidade de intercomunicador, sem fio, que permita comunicações verbais, para utilização em caso de
emergência.
...
**2.10.19.1** Caso as condições de visibilidade não permitam a completa visão do trajeto do mergulhador por uma câmara de TV fixa, será obrigatório o uso de câmara instalada em veículo
...
III. de forma que todas as redes que atravessem seu corpo disponham, interna e externamente próximo ao ponto de penetração, de válvulas ou outros dispositivos
...
A) com sistema de controle de temperatura e umidade relativa do meio ambiente; B) com sistema sanitário completo, incluindo vaso, chuveiro e lavatório com água quente
...
b) o período de realização da operação; c) o nome ou outra designação da plataforma de mergulho, sua localização e o nome do seu
...
periférica (varizes e hemorróidas) acarretam a inaptidão. 3. APARELHO RESPIRATÓRIO
...
a critério do médico responsável pelo exame de saúde do mergulhador. **ANEXO “C”**
...
maior profundidade alcançada durante o mergulho. Exemplo: Profundidade máxima = 12,5 metros.
...
57 5 5 **TABELA DE NITROGÊNIO RESIDUAL PARA MERGULHOS**
...
40 4:24 0 3 5 8 32 61:24 45 4:00 3 4 8 8 38 73:00
...
15 2:30 3 3 5 18:00 20 2:30 4 4 15 30:00
...
Sua coordenação motora está normal? **TRATAMENTO DE EMBOLIA GASOSA**
...
![Tabela da página 65](../assets/pages/page-065-table-01.png)

![Tabela da página 65](../assets/pages/page-065-table-02.png)
...
![Tabela da página 66](../assets/pages/page-066-table-00.png)
...
![Tabela da página 67](../assets/pages/page-067-table-00.png)
...
![Tabela da página 78](../assets/pages/page-078-table-00.png)

![Página 78 — imagem 0](../assets/pages/page-078-image-00.png) **ANEXO Nº 7**
...
**3.** Todos os valores fixados no Quadro n. [o] 1 como "Asfixiantes Simples" determinam que nos ambientes de trabalho, em presença destas substâncias, a concentração mínima de oxigênio
...
![Tabela da página 82](../assets/pages/page-082-table-00.png)

**TABELA DE LIMITES DE TOLERÂNCIA**

![Tabela da página 83](../assets/pages/page-083-table-00.png)

![Tabela da página 84](../assets/pages/page-084-table-00.png)

![Tabela da página 85](../assets/pages/page-085-table-00.png)

![Tabela da página 86](../assets/pages/page-086-table-00.png)

(1) _(Incluído pela Portaria DNSST nº 09, de 09 de outubro de 1992)_

![Tabela da página 87](../assets/pages/page-087-table-00.png)

![Tabela da página 87](../assets/pages/page-087-table-01.png)
...
![Tabela da página 88](../assets/pages/page-088-table-00.png)
...
data e local da próxima avaliação médica. **20.** O empregador deve garantir informações e treinamento aos trabalhadores, com freqüência
...
da data de sua publicação, revogadas as disposições em contrário. **ANEXO Nº 1**
...
![Tabela da página 97](../assets/pages/page-097-table-00.png)
...
Operações de galvanotécnica à base de compostos de arsênico. Pintura manual (pincel, rolo e escova) com pigmentos de compostos de arsênico em recintos
...
de poliisocianetos e poliuretanas). Emprego de produtos contendo hidrocarbonetos aromáticos como solventes ou em limpeza de
...
situação de risco grave e iminente para o trabalhador. Para o Benzeno, deve ser observado o disposto no anexo 13-A.
...
emanação de vapores e prevenção de contato direto do trabalhador com o benzeno; - descrição dos procedimentos e recursos necessários para o controle da situação de emergência,
...
emergência - descrever as condições em que a emergência ocorreu indicando: - atividade; local, data e hora da emergência;
...
![Tabela da página 111](../assets/pages/page-111-table-00.png)

14 Agentes biológicos. 20% e 40%

![Tabela da página 112](../assets/pages/page-112-table-00.png)
