...
fatores: I - dimensões das embalagens de explosivos a armazenar;
...
considerados: I - como construção única, os depósitos de explosivos cujas distâncias entre si sejam inferiores às
...
descarga de explosivos devem ser feitos durante o dia e com tempo sem ocorrência de intempéries; e l) quando houver necessidade de carregar ou descarregar explosivos durante a noite, somente será
...
número daqueles, de acordo com o dimensionamento previsto na Norma Regulamentadora nº 24 (NR-24), localizadas estrategicamente de forma a atender todo o perímetro da fábrica, à distância
...
**18.2** É vedada a fabricação de fogos de artifícios ou outros artifícios pirotécnicos com as matérias primas proibidas pela legislação da Diretoria de Fiscalização de Produtos Controlados do Exército
...
da Tabela 1 devem ser aplicadas; e b) quando os produtos forem armazenados próximos a outros materiais, com os quais podem formar
...
![Tabela da página 22](../assets/pages/page-022-table-01.png)
...
![Tabela da página 23](../assets/pages/page-023-table-01.png)
...
![Tabela da página 24](../assets/pages/page-024-table-01.png)
...
![Tabela da página 25](../assets/pages/page-025-table-01.png)
...
dos trabalhos. **Dinamite** : são todos os que contêm nitroglicerina em sua composição, exigindo maior cuidado em seu
