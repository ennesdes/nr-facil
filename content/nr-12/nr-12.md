...
**9.** Para o sistema de proteção contra quedas em plataformas utilizadas em operações de abastecimento ou que acumulam sujidades, é permitida a adoção das dimensões da Figura 3 deste Anexo. Este texto não substitui o publicado no DOU 
