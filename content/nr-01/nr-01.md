...
**1.5.3.1** A organização deve implementar nos seus estabelecimentos o gerenciamento de riscos ocupacionais de suas atividades. 
...
**1.5.4.4.1** A organização deve avaliar os riscos ocupacionais relativos aos perigos identificados em seu(s) estabelecimento(s), de forma a manter informações para adoção de medidas de 
...
- b) após inovações e modificações nas tecnologias, ambientes, processos, condições, <u>procedimentos e organização do trabalho que impliquem em novos riscos ou modifiquem</u> 
...
Ordem de serviço de segurança e saúde no trabalho: instruções por escrito quanto às precauções para evitar acidentes do trabalho ou doenças ocupacionais. A ordem de serviço pode estar 
