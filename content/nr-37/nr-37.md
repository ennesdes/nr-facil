...
| Velocidade
do vento | Condições para operação do equipamento de guindar |
| --- | --- |
| 0 a 38 km/h | - Permitidas todas as operações de movimentação de
cargas. |
...
| 50 a 61 km/h | - Permitidas apenas as operações assistidas e
realizadas somente dentro da própria plataforma,
com observação contínua das condições climáticas. |
| Acima de 61
km/h | - Todas as operações devem ser interrompidas. |
