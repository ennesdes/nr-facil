...
II. Avaliação do local de trabalho e do trabalhador, considerando: - a) a finalidade e descrição do local de trabalho; 
...
- d) equipamentos de proteção individual e vestimentas para uso e reposição; - e) armários para guarda de pertences; 
...
- i) relatórios sobre exposições de emergência e de acidente; j) exposições ocupacionais anteriores a fonte de radiação. 
...
a) blindagem; - b) paredes e pisos com cantos arredondados, revestidos de materiais impermeáveis, que permitam sua descontaminação; 
...
**32.4.15.2** A cabine de comando deve ser posicionada de forma a: - a) permitir ao operador, na posição de disparo, eficaz comunicação e observação visual do paciente; 
...
![Página 38 (tabelas)](../assets/pages/page-038-table-full.png) Fontes:
...
**10.1** O plano deve ser avaliado a cada ano, no mínimo, e sempre que se produza uma mudança nas condições de trabalho e quando a análise das situações de risco e dos acidentes assim o determinar. GLOSSÁRIO DA NR-32
...
a) salvar vidas; b) prevenir a escalada de acidentes que possam acarretar mortes; 
...
**Microrganismos geneticamente modificados:** são aqueles em que o material genético (DNA) foi alterado por tecnologias da biotecnologia moderna, especialmente a tecnologia do DNA recombinante. A biotecnologia moderna abrange métodos artificiais de alteração do material 
...
**Serviço de Medicina Nuclear:** instalação médica específica para aplicação de radiofármacos em pacientes, para propósitos terapêuticos e/ou diagnósticos. 
