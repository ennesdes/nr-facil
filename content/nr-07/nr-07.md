...
| 2,4 e 2,6 Tolueno diisocianato | 58484-9 9108-7 | Isômeros 2,4 e 2,6 toluenodiamino | FJ | 5 µg/g creat. | NE |
...
| Etoxietanol e Etoxietilacetato | 1. 111-15-9 | Ácido etoxiacético na urina | FJFS | 100 mg/g creat. | - |
| Fenol | 108-95-2 | Fenol(H) na urina | FJ | 250 mg/g creat. | EPNE, NE |
| Furfural | 98-01-1 | Ácido furóico(H) na urina | FJ | 200 mg/L | NE |
| Indutores de Metahemoglobin a | | Metahemoglobina no sangue | FJ | 1,5% da hemoglobin a | EPNE, NE |
...
| n-hexano | 110-54-3 | 2,5 hexanodiona(SH) (2,5H D) na urina | FJ | 0,5 mg/L | - |
...
| N,N Dimetilformamid a | 68-12-2 | Nmetilformamida total1 na urina 1(soma da N-metilformamida e N-(hidroximetil)-N-metilformamida) ou | FJ | 30 mg/L | - |
...
| Xilenos | 9547-6 10642-3 10838-3 1330-27-7 | Ácido metilhipúrico na urina | FJ | 1,5 mg/g creat. | - |
...
(M) Mulheres em idade fértil, com valores de Chumbo no sangue (Pb-S) a partir de 30 µg/100ml, devem ser afastadas da exposição ao agente. Abreviaturas
...
![Tabela da página 13](../assets/pages/page-013-table-00.png)
...
# **MODELO DE FORMULÁRIO PARA REGISTRO DE TRAÇADO AUDIOMÉTRICO** ORELHA DIREITA Frequência em kHz ORELHA ESQUERDA Frequência em kHz
...
![Tabela da página 30](../assets/pages/page-030-table-00.png)
...
![Tabela da página 31](../assets/pages/page-031-table-00.png)
...
![Tabela da página 32](../assets/pages/page-032-table-00.png)

![Tabela da página 32](../assets/pages/page-032-table-01.png)

![Tabela da página 33](../assets/pages/page-033-table-00.png)

![Tabela da página 34](../assets/pages/page-034-table-00.png)
...
![Tabela da página 35](../assets/pages/page-035-table-00.png)
...
**5.4** Os prontuários médicos dos empregados expostos a radiações ionizantes devem ser mantidos até a data em que o empregado completará 75 anos e, pelo menos, por período mínimo de 30 (trinta) anos após o desligamento do empregado. GLOSSÁRIO
